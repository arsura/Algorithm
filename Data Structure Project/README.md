# Trie
  ...
  **อ้างอิง** <br/>
  (1) [Trie | (Insert and Search) - GeeksforGeeks](http://www.geeksforgeeks.org/trie-insert-and-search/) พื้นฐานและไอเดียในการเขียนโค้ด <br/>
  (2) [Trie - Wikipedia](https://en.wikipedia.org/wiki/Trie) <br/>
  (3) [ทรัย (โครงสร้างข้อมูล)](https://th.wikipedia.org/wiki/ทรัย_(โครงสร้างข้อมูล)) <br/>
  (4) [Data Structures and Algorithm Analysis, Clifford A. Shaffer p.439 - 443](http://people.cs.vt.edu/~shaffer/Book/C++3elatest.pdf)      <br/>
